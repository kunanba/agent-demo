"""
Document ingestion using Azure OpenAI embeddings (text-embedding-ada-002).
This version avoids sentence-transformers dependency issues.
"""
...
class DocumentProcessorAzure:
    """Processes and indexes financial documents using Azure OpenAI embeddings."""
    ...
    def _ensure_index_exists(self):
        ...
        with self.telemetry.trace_operation("create_search_index"):
            ...
            # Define index schema (text-embedding-3-large with 1536 dimensions)
            fields = [
...
if __name__ == "__main__":
    ...
    processor = DocumentProcessorAzure()
